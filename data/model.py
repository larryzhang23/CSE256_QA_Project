...
class InputEmbedding(nn.Module):
    def __init__(self, numChar, dimChar=16, dimGlove=50):
        ...
        self.hn = HighwayNetwork(dim=dimGlove + dimChar)
...
class BaseClf(nn.Module):
    def __init__(self, numChar, dimChar=16, dimGlove=50) -> None:
        ...
        self.input_emb_c = InputEmbedding(numChar=numChar, dimChar=dimChar)
        # [B, sent_length, 400]
    ...
    def forward(self, q, c):
        ...
        emb_c = torch.mean(self.input_emb_q(c), dim=1)
...
if __name__ == "__main__":
    ...
    subsetTrain = Subset(squadTrain, [i for i in range(16)])
    # import pdb
    ...
    trainer(500, trainLoader, model, criterion, optimizer)
